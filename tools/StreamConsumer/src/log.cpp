...
void openLogFile(char *logFile)
{
	...
	char name[256];
	StringCchPrintf(name, 256, "\\%s%.4d%.2d%.2d-%.2d%.2d%.2d-%.3d-Consumer.log", logFile, st.wYear, st.wMonth, st.wDay, st.wHour, st.wMinute, st.wSecond, st.wMilliseconds);
