...
static HANDLE shared_handle = NULL;
...
int createSharedMemory()
{
	...
	shared_handle = CreateFileMapping(INVALID_HANDLE_VALUE, &SA_ShMem, PAGE_READWRITE, 0, sizeof(SHARED_DATA), "Global\\$TVSchedulerProSHARED$");
...
{
   shared_handle = OpenFileMapping(FILE_MAP_ALL_ACCESS, FALSE, "Global\\$TVSchedulerProSHARED$");
